...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="replyAction_add" style="margin: 0; padding: 0;">
	...
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<s:a action="forumAction_show?id=%{#topic.forum.id}">销售常见问题</s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				帖子回复
			</div>
		</div>
						...
						<table cellpadding="0" border="0" cellspacing="0">
							...
							<s:iterator begin="1" end="14" var="num">
								<td width="50" style="border-bottom:0 solid #ffffff">
									...
									<label for="r_${num }"><img width="19" height="19" src="${pageContext.request.contextPath}/style/images/face/${num }.gif" align="absmiddle" disabled="true"/></label>
								</td>
							</s:iterator>
							</tr>
						</table></div>
